...
namespace MysteriousAlchemy.Utils
{
    public static class TileUtils
    {
        ...
        public static TileEntity GetTileEntity(int i, int j)
        {
        ...
        public static Vector2 GetCenterMultitile(int i, int j)
        {
            ...
            if (tile.HasTile)
            {
                ...
                result = new Vector2(i - frameX, j - frameY) * 16 + new Vector2(data.CoordinateFullWidth / 2f - data.CoordinateWidth / 3f, data.CoordinateFullHeight / 2f);
            }
