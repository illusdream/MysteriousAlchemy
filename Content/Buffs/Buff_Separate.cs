...
{
    public class Buff_Separate : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            dust = Main.dust[Terraria.Dust.NewDust(player.Center - player.Hitbox.Size() / 2f, player.width, player.height, DustID.Blood, 0, 0, 0, new Color(255, 255, 255), 1.0465117f)];
            dust.noGravity = true;
        ...
        public override void Update(NPC npc, ref int buffIndex)
        {
            Dust dust;
            // You need to set position depending on what you are doing. You may need to subtract width/2 and height/2 as well to center the spawn rectangle.
            dust = Main.dust[Terraria.Dust.NewDust(npc.Center - npc.Hitbox.Size() / 2f, npc.width, npc.height, DustID.Blood, 0, 0, 0, new Color(255, 255, 255), 1.0465117f)];
            dust.noGravity = true;
            dust.fadeIn = 0.69767445f;
