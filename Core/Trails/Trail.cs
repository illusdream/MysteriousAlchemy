...
namespace MysteriousAlchemy.Core.Trails
{
    public class Trail : IDisposable
    {
        ...
        private readonly TrailWidthModify trailWidthModify;
        private readonly TrailColorModify trailColorModify;
        ...
        public Trail(GraphicsDevice device, int maxPointCount, ITrailTip tip, TrailWidthModify trailWidthModify, TrailColorModify trailColorModify, bool flipVertical = false)
        {
            this.tip = tip ?? new NoTip();
            this.maxPointCount = maxPointCount;
            this.trailWidthModify = trailWidthModify;
            this.trailColorModify = trailColorModify;
        ...
        private void GenerateMesh(out VertexPositionColorTexture[] vertices, out short[] indices, out int nextAvailableIndex)
        {
            ...
            for (int k = 0; k < Positions.Length; k++)
            {
                ...
                float width = trailWidthModify?.Invoke(factorAlongTrail) ?? defaultWidth;
                ...
                Color colorA = trailColorModify?.Invoke(texCoordA) ?? Color.White;
                Color colorC = trailColorModify?.Invoke(texCoordC) ?? Color.White;
        ...
        private void SetupMeshes()
        {
            ...
            tip.GenerateMesh(Positions[Positions.Length - 1], toNext, nextAvailableIndex, out VertexPositionColorTexture[] tipVertices, out short[] tipIndices, trailWidthModify, trailColorModify);
        ...
        public void Render(Action effectAction)
        {
            ...
            primitives.Render(effectAction);
        }
